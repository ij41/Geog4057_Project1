...
import arcpy
import os
def importNoTaxJson(workspace=r'C:\Users\israt\OneDrive\Desktop\GEOG_4057\Project\DATA',json_file='no_tax.json',out_fc='notax_fc_1.shp'):
    
    with open(json_file, 'r') as file:
        tax_json = json.load(file)
        
    arcpy.FromWKT(tax_json["data"][100][8])
